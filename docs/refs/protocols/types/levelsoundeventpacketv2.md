...
- 基本类型枚举。protocol.packet.levelsoundeventpacketv2.event_id.description枚举值如下：
...
- 特殊类型。protocol.packet.levelsoundeventpacketv2.position.description
...
- 基本类型。protocol.packet.levelsoundeventpacketv2.data.description
...
- 特殊类型。protocol.packet.levelsoundeventpacketv2.actor_identifier.description
...
- 基本类型。protocol.packet.levelsoundeventpacketv2.baby_mob.description
...
- 基本类型。protocol.packet.levelsoundeventpacketv2.global.description
