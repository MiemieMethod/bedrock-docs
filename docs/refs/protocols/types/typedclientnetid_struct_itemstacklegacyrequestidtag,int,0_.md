# <!-- md:samp TypedClientNetId&lt;struct ItemStackLegacyRequestIdTag,int,0&gt; -->
...
- 基本类型。protocol.type.typedclientnetid&lt;struct_itemstacklegacyrequestidtag,int,0&gt;.raw_id.description
