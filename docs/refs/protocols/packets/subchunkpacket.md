...
- 基本类型。protocol.packet.subchunkpacket.cache_enabled.description
...
- 基本类型。protocol.packet.subchunkpacket.dimension_type.description
...
- 特殊类型。protocol.packet.subchunkpacket.center_pos.description
