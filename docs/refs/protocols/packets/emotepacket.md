...
```title='EmotePacket'
[actor_runtime_id][emote_id][emote_length_ticks][xuid][platformid][flags]
```
...
////
//// define
Emote Length Ticks：<!-- md:samp unsigned varint -->

- 基本类型。protocol.packet.emotepacket.emote_length_ticks.description
