...
`tileData`：<!-- md:samp int -->

- 基本类型，可选。command.setblock.tileData.description

`oldBlockHandling`：<!-- md:samp SetBlockMode -->

- 枚举类型，可选。command.enum.setblockmode.description枚举值如下：

  |值|描述|
  |---|---|
  |`replace`|command.enum.setblockmode.replace|
  |`destroy`|command.enum.setblockmode.destroy|
  |`keep`|command.enum.setblockmode.keep|
...
//// html | div.result
command.setblock.2.description
...
- 基本类型。command.setblock.blockStates.description
...
//// html | div.result
command.setblock.3.description
