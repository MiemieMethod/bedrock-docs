...
`/give`命令command.give.description
...
//// html | div.result
command.give.1.description

///// define
`player`：<!-- md:samp target -->

- 基本类型。command.give.player.description
...
- 基本类型，可选。command.give.amount.description

`data`：<!-- md:samp int -->

- 基本类型，可选。command.give.data.description

`components`：<!-- md:samp json -->

- 基本类型，可选。command.give.components.description
