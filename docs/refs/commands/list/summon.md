...
//// html | div.result
<!-- md:version command * 30 true true -->
...
`spawnEvent`：<!-- md:samp EntityEvents -->
...
//// html | div.result
<!-- md:version command 31 * true true -->
...
- 基本类型。command.summon.nameTag.description
...
- 基本类型。command.summon.lookAtPosition.description
...
- 基本类型。command.summon.lookAtEntity.description
