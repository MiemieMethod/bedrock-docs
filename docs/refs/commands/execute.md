...
`/execute`命令Executes a command on behalf of one or more entities.
...
`chainedCommand`: <!-- md:samp EXECUTECHAINEDOPTION_0 -->
...
`scan mode`: <!-- md:samp BlocksScanMode -->
...
`operation`: <!-- md:samp compare operator -->

- 基本类型。

`source`: <!-- md:samp target -->
