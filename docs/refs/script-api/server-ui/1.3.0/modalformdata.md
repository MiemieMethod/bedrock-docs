...
/// html | div.result
//// define
`label`：[`RawMessage`](../../server/1.3.0/rawmessage.md)|`string`
...
/// html | div.result
//// define
`player`：[`Player`](../../server/1.3.0/player.md)
...
/// html | div.result
//// define
`submitButtonText`：[`RawMessage`](../../server/1.3.0/rawmessage.md)|`string`
...
//// define
`placeholderText`：[`RawMessage`](../../server/1.3.0/rawmessage.md)|`string`
...
//// define
`defaultValue`?：[`RawMessage`](../../server/1.3.0/rawmessage.md)|`string`＝`null`
...
/// html | div.result
//// define
`titleText`：[`RawMessage`](../../server/1.3.0/rawmessage.md)|`string`
