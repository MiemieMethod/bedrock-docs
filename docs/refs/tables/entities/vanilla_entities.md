...
/// abstract | 描述
本页列出Microsoft Learn“Default Minecraft Entity Listings”公开的原版实体标识符、完整数值ID与短数值ID。该表可用于实体调试、旧接口兼容核对与协议数据对照。
///
...
|`zoglin`|`68478`|`126`|
|`zombie`|`199456`|`32`|
|`zombie_horse`|`2183963`|`27`|
|`zombie_nautilus`|`74646`|`150`|
