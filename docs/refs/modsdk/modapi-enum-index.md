...
本页根据知识库`.knowledge\EaseCation Wiki\docs\mcdocs\1-ModAPI\枚举值`目录整理中国版ModAPI枚举值。该目录共74个Markdown文件，其中1个为索引页，73个为具体枚举值说明页。
...
知识库索引指出，枚举值可通过`GetMinecraftEnum`接口获取。该能力属于中国版模组SDK通用工具接口体系。
