...
本页整理`.knowledge\中国版API参考\3-PresetAPI`目录内容。该目录共39个Markdown文件，包括1个预设管理页、25个预设对象页和13个更新信息页。PresetAPI属于中国版模组SDK扩展体系，不适用于国际版脚本API。
...
来源：`3-PresetAPI\预设管理\PresetApi.md`。
