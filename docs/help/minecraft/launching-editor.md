...
- 当前可用流程以Windows电脑与键盘鼠标为主，并以Minecraft Preview为主要入口。
- 编辑器相关页面仍覆盖概览、安装、教程与扩展入门，因此不应把编辑器视为已经撤下的旧入口。

## 先安装Minecraft Preview

Windows端常见的Preview安装路径为：
...
协议地址区分大小写。若快捷方式打开了普通游戏而不是编辑器，应先检查协议写法是否正确，再检查地址是否拼写完整。
