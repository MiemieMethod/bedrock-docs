...
- :material-coffee: __[Nukkit与PocketMine服务端](nukkit-pocketmine.md)__
  了解Nukkit-MOT安装、插件放置，以及PocketMine-MP的启动、配置和插件清单。
///
...
- 维护PHP服务端或PocketMine-MP插件：先看PocketMine-MP相关说明，并核对安装、配置和插件要求。
