...
如果想沿着文档的原始脉络阅读，可先打开[LeviLamina文档归档](../../translations/levilamina/index.md)。
...
3. 只有在需要查看首页分工时，再对照[文档首页](../../translations/levilamina/official-docs-home.md)与[项目说明页](../../translations/levilamina/repository-readme.md)。
...
- :material-book-open-variant: __[相关页面总览](../../translations/levilamina/index.md)__
  查看LeviLamina相关页面的翻译导航与入口。
...
本节只保留服务端最短命令链。前提条件、镜像设置、手动安装目录结构和升级说明以[在服务器上安装](../../translations/levilamina/install-server.md)为准。LeviLamina文档推荐通过lip安装；Windows环境需要Windows10、Windows11、Windows Server2019或Windows Server2022，并需要安装Visual C++ Redistributable for Visual Studio2015、2017、2019和2022。
...
lip会替你处理大多数文件。手动安装时，文档列出的关键部件包括LeviLamina本体、PreLoader、PeEditor、bedrock-runtime-data、CrashLogger、对应版本的BDS和可选的本地化文件。处理完成后，服务端目录中通常会出现{{file|bedrock_server_mod.exe}}和{{file|plugins}}目录。
