...
在教程[创建你的第一个模组](create-your-first-mod.md)中，我们创建了一个简单的模组。在本教程中，我们将学习如何发布模组。

### 前置条件

首先，你应当确保你安装了[lip](https://lip.levimc.org)。

你还应当按照[创建你的第一个模组](create-your-first-mod.md)中的步骤创建了一个模组，其中模组导出目录有类似如下的结构：
...
在一段时间后，你也可以在<pkg.levimc.org>查看到你的模组了。