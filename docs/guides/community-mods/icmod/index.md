...
Nernar维护的InnerCore文档同时包含英文教程、俄文翻译、库文档、变更记录和站点工程文件。英文教程中有一部分页面仅含“未本地化”占位，维度、生物群系、方块实体、发布和部分库资料并不完整。因此，本组页面只整理知识库中已有且可核验的内容；缺失处会明确标注为资料不足，不补写未经资料支持的API细节。
