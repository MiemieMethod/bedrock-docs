...
<!-- 图片获取方式：从资料源文件custom-crafting.md中的recipe.png提取。 -->

![产物投掷器](../../../assets/images/guides/misc/custom-crafting/recipe-output.png)
<!-- 图片获取方式：从资料源文件custom-crafting.md中的recipe-output.png提取。 -->
...
<!-- 图片获取方式：从资料源文件custom-crafting.md中的completed-setup.png提取。 -->
