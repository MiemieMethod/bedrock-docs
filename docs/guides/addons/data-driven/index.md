...
1. [制作模型](creating-models.md)：先学会用Blockbench导出几何体和纹理。
2. [认识Molang](understanding-molang.md)：理解动画、粒子和渲染条件中常见的表达式。
3. 自定义实体、方块、物品：学习最常见的三种内容。
4. 粒子、声音、配方、战利品表：给内容补上反馈和玩法循环。
5. 迷雾、地物、生物群系、维度、功能域：进入世界生成和环境效果。
