...
本文档不会在理论上花费太多时间，主要任务是在学习文章的同时开始创建内容。准备好所需的环境，[安装引擎](getting-started/installing-pack)并下载[Inner Core模组工具链](https://github.com/zheka2304/innercore-mod-toolchain/blob/master/说明页-ru.md)。使用本站各部分的标签页以获取更多信息。