...
确保添加雪球的运行时标识符，以使您的投射物实际被射出，而不是生成。您还可以尝试其他投射物的运行时ID。
...
您可以通过编辑`minecraft:projectile`组件来自定义其行为，在这种情况下，投掷的物品将给予一些经验并对其命中的任何实体造成伤害。

## 结论

一旦您拥有了可投掷物品，就可以开始尝试多种事情，例如调整其威力、效果、动画或将其与[AOE云](../entities/introduction-to-aec.md)结合。唯一的限制是您的想象力。