...
mentions:
    - MedicalJewel105
description: 自动生成的声音，来自 sound_definitions.json，并按类别和子类别排序。
---

来自 `sound_definitions.json` 的声音，按名称的类别和子类别排序。
此页面由 [Wiki 内容生成器](https://github.com/Bedrock-OSS/bedrock-wiki-content-generator) 创建。如有问题，请在 [Bedrock OSS](https://discord.gg/XjV87YN) Discord 服务器上联系我们。
*最后更新于 1.21.0*
