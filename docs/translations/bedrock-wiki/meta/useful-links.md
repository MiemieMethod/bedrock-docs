...
- [Amulet与MCEdit](https://discord.gg/dSnwqQf)
...
- ⭐[Blockbench：专为方块风格设计的3D建模工具](https://blockbench.net/)
...
- [CoreCoder代码编辑器](https://hanprog.itch.io/core-coder)
...
- [资源包转换器](https://converter.bedrockhub.io)
- [BedrockConnect](https://bedrockconnect.bedrockhub.io)

## 基岩版在线工具

- ⭐[Snowstorm粒子效果生成器](https://jannisx11.github.io/snowstorm/)
...
- [《基岩版附加包开发入门指南》](https://learn.microsoft.com/en-us/minecraft/creator/documents/gettingstarted)：手把手创建第一个资源包和行为包。
- [《Molang语言入门指南》](https://learn.microsoft.com/en-us/minecraft/creator/documents/molangbeginnersguide)：理解这门专为Minecraft设计的脚本语言。
- [《GameTest框架入门》](https://learn.microsoft.com/en-us/minecraft/creator/documents/gametestgettingstarted)：使用JavaScript进行游戏测试的入门说明。
...
- [《命令大全（非官方Wiki）》](https://minecraft.wiki/w/Commands#List_and_summary_of_commands)：社区维护的命令参考手册。
...
- [Substance3D Painter插件](https://github.com/jasonjgardner/painter-plugin-texture-set-json)
...
- [UUIDv4生成器](https://www.uuidgenerator.net/version4)
