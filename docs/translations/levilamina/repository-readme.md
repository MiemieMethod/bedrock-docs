...
- 对应来源：`.knowledge\LeviLamina源码及文档\README.zh.md`
///
...
开发者可以轻松地用C++编写模组。这种无缝集成赋予了他们轻松扩展和个性化游戏功能的能力，促进了直观的学习体验和无与伦比的灵活性。
...
> [!WARNING]
> **你应该仔细阅读并遵守我们的 [EULA](https://github.com/LiteLDev/LeviLamina/blob/HEAD/EULA.zh.md) 与 [使用准则](usage-guidelines.md)。**
...
本项目的非闭源部分采用LGPL-3.0许可证发行-阅读[COPYING](COPYING)和[COPYING.LESSER](COPYING.LESSER)文件获取更多信息。
