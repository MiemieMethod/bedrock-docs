...
与[文档首页](official-docs-home.md)相比，本页更接近项目首页说明页：两者都重复出现项目简介与社区入口，但本页额外承担安装入口、贡献入口与许可证声明的聚合作用。

如需对照文档站入口页中的社区入口与首页鸣谢信息，可再查看[文档首页](official-docs-home.md)。

## 中英文镜像关系

LeviLamina仓库同时提供`README.zh.md`和`README.md`两份首页说明。两者在项目定位、社区入口、安装入口、贡献入口和许可证声明上基本一致，但链接落点与个别表述存在差异：

- 中文版说明页直接链接中文EULA与中文使用指南。
- 英文版说明页链接英文EULA与英文使用指南镜像。
- 中文版说明页在贡献部分将行为准则表述为“行为准则”，英文版则直接链接Contributor Covenant行为准则页面。
- 中文版说明页中的语言切换按钮以中文页为当前页；英文版说明页中的按钮状态则与之相反。

因此，本站以中文说明页作为主要转述对象，同时用英文说明页复核镜像关系和链接差异，避免把中文页中的站内转述误当成唯一版本。
...
- 需要理解首页承担的门户与鸣谢职责时，查看[文档首页](official-docs-home.md)。
