...
ModVersion = '1.0.0'
ServiceSystemName = 'neteaseMatchServiceSystem'
ServiceSystemClsPath = 'neteaseMatchScript.matchServiceSystem.MatchServiceSystem'

# service 事件
MatchPlayerDieEvent = "MatchPlayerDieEvent"
MatchPlayerLogoutEvent = "MatchPlayerLogoutEvent"
ApplyToMatchServiceEvent = 'ApplyToMatchServiceEvent'
PlayerEnterServerEvent = 'PlayerEnterServerEvent'
PlayerQuitServerEvent = 'PlayerQuitServerEvent'

ApplyErrServiceEvent = 'ApplyErrServiceEvent'
ShowWaitUIServiceEvent = 'ShowWaitUIServiceEvent'
WaitNumChangedServiceEvent = 'WaitNumChangedServiceEvent'
MatchResultServiceEvent = 'MatchResultServiceEvent'
ConfirmOKServiceEvent = 'ConfirmOKServiceEvent'
GetLoginUIServiceEvent = 'GetLoginUIServiceEvent'
RequestCancelMatchServiceEvent = 'RequestCancelMatchServiceEvent'
#错误提示信息
CodeSuccess = 0
