...
class DungeonsData(object):
	...
	def GetTypeData(self, dungeonType):
		return self.mDungeonType2TypeData.get(dungeonType, None)

dungeonData = DungeonsData()

def GetDungeonTypeData(dungeonType):
	global dungeonData
	return dungeonData.GetTypeData(dungeonType)