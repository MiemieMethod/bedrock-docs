...
class TutorialMod(object):
    ...
    def TutorialClientInit(self):
        ...
        clientApi.RegisterSystem("Minecraft", "TutorialBehavior", "tutorialScripts.tutorialClientSystem.TutorialClientSystem")
    
    # DestroyClient绑定的函数作为客户端脚本退出的时候执行的析构函数，通常用来反注册一些内容,可为空
    @Mod.DestroyClient()
    def TutorialClientDestroy(self):
        print "===== destroy tutorial client ====="
