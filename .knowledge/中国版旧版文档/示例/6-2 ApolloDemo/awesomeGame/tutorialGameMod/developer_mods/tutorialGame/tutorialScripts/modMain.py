...
@Mod.Binding(name = "TutorialGame", version = "0.1")
class TutorialMod(object):

    # 类的初始化函数
    def __init__(self):
        print "===== init tutorial Game ====="
    ...
    def TutorialServerInit(self):
        ...
        serverApi.RegisterSystem("Minecraft", "TutorialGame", "tutorialScripts.tutorialServerSystem.TutorialServerSystem")
